...
<% 
	...
	if(inputText == null){
		...
		outStr.append("Sentence : " + inputText);
		...
		ArrayList<String> list = objMG.getWordPairs(inputText.toLowerCase());
...
<div class="panel panel-primary">
  ...
  <center>
    <br>
	Enter a sentence:
	<form id="mform" method="post" action="metaphor.jsp">
		<input type="text" id="inputText" size="100"></input>
